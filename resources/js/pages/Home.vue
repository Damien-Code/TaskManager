    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            <div class="relative min-h-[100vh] flex-1 rounded-xl md:min-h-min">
                <section class="bg-white dark:bg-background">
                    ...
                    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                        ...
                        <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                            <div>
                                ...
                                <p class="text-gray-500 dark:text-gray-400">From brainstorming ideas to launch day checklists — keep every part of your marketing workflow organized and on time. Collaborate easily and hit your goals faster.</p>
                            </div>
                            <div>
                                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                                ...
                                <p class="text-gray-500 dark:text-gray-400">From follow-ups to filings, manage all your legal to-dos with ease. Perfect for solo lawyers, small teams, or anyone who needs legal clarity without the chaos.</p>
                            </div>
                            <div>
                                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 dark:text-gray-400">Track financial tasks like budgeting, invoicing, and monthly reporting with ease. Our simple task manager helps you stay organized, meet deadlines, and keep everything audit-ready.</p>
                            </div>
                            <div>
                                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500 dark:text-gray-400">Our app simplifies daily operations by organizing tasks efficiently, improving workflow, and ensuring deadlines are met with ease.</p>
                            </div>
                        </div>
                    </div>
                </section>
